                    ...
                    <div className="hidden md:block">
                        <nav aria-label="Global" className="">
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                {[
                                    '', "Destinations", "Hotels", "Cab Booking", "Tours", "Activities"
                                ].map((item, index) => (
                                    <li key={index}>
                                        <Link href={`/${item.toLowerCase()}`} className="text-white transition hover:text-white/75"> {item  || "Home"} </Link>
                                        {/* <a className="text-white transition hover:text-white/75" href="#"> {item} </a> */}
                                    </li>
                                ))}
                    ...
                    <div className="flex items-center gap-4">
                        <div className="sm:flex sm:gap-4">
                            ...
                            <div className="hidden sm:flex">
                                <Link
                                    className="rounded-md bg-black px-5 py-2.5 text-sm font-medium "
                                    href="/register"
                                >
                                    Register
                                </Link>
