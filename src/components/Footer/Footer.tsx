    ...
    return (
        <footer className="bg-green-950">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-0 sm:px-6 lg:px-8">
                ...
                <div
                    className="mt-0 grid grid-cols-1 gap-8 border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6 border-t-0"
                >
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a className="text-white transition hover:text-white/75" href="#"> Meet the Team </a>
                            </li>
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            <li>
                                <a className="text-white transition hover:text-white/75" href="#"> Online Guides </a>
                            </li>
                            ...
                            <li>
                                <a className="text-white transition hover:text-white/75" href="#"> Forum </a>
                            </li>

                            <li>
                                <a className="text-white transition hover:text-white/75" href="#"> Downloads </a>
                            </li>
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a
                                    ...
                                    href="#"
                                >
                                    <span className="text-white transition group-hover:text-white/75"> Live Chat </span>
